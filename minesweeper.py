...
class MinesweeperAI():
    ...
    def cells_neighbors(self, cell, count):
        neighbors = set()
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence = self.cells_neighbors(cell, count)
        ...
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                if sentence1.cells.issubset(sentence2.cells) and len(sentence1.cells) != 0 and len(sentence2.cells) != 0 and sentence1 != sentence2:
                    new_count = sentence2.count - sentence1.count
                    new_cells = sentence2.cells - sentence1.cells
                    new_sentence1 = Sentence(new_cells, new_count)
                    if new_sentence1 not in self.knowledge:
                        self.knowledge.append(new_sentence1)
                elif sentence2.cells.issubset(sentence1.cells) and len(sentence1.cells) != 0 and len(sentence2.cells) != 0 and sentence1 != sentence2:
    ...
    def make_random_move(self):
        ...
        for i in range(self.width):
            for j in range(self.height):
                cell_random = (i, j)
                if cell_random not in self.mines and cell_random not in self.moves_made:
                    return cell_random
